  ...
  const infoCards = [
    {
      ...
      content: "El asesoramiento inmobiliario es un servicio profesional que te guía en todas las etapas de compra, venta o gestión de propiedades. Nuestros expertos te proporcionan información valiosa sobre el mercado, aspectos legales y financieros para que tomes las mejores decisiones inmobiliarias."
    },
    {
      icon: <Target className="w-8 h-8 text-green-500" />,
      title: "¿Cómo te podemos ayudar?",
      content: "Nuestro equipo de asesores inmobiliarios puede ayudarte a encontrar la propiedad perfecta que se ajuste a tus necesidades y presupuesto, negociar el mejor precio, gestionar toda la documentación necesaria, y brindarte apoyo en cada paso del proceso de compra o venta de tu inmueble."
    },
    {
      ...
      <Card className="w-full bg-gradient-to-r from-purple-600 to-blue-600 text-white">
        ...
        <CardContent>
          <p className="text-center text-sm md:text-base">
            En M&W Bienes Inmuebles, ofrecemos asesoramiento profesional para todas tus necesidades inmobiliarias. Ya sea que estés buscando comprar o vender, nuestro equipo de expertos está aquí para guiarte en cada paso del camino.
          </p>
        </CardContent>
      </Card>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-8">
        {infoCards.map((card, index) => (
          <Card key={index} className="bg-gradient-to-br from-emerald-50 to-teal-100 dark:from-emerald-900 dark:to-teal-800 transition-all duration-300 hover:shadow-lg hover:scale-105">
            ...
            <CardContent>
              <p className="text-emerald-800 dark:text-emerald-200">{card.content}</p>
            </CardContent>
          </Card>
        ))}
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-8">
        {servicios.map((servicio, index) => (
          <Card key={index} className="bg-gradient-to-br from-blue-50 to-indigo-100 dark:from-blue-900 dark:to-indigo-800 transition-all duration-300 hover:shadow-lg hover:scale-105">
            ...
            <CardContent>
              <p className="text-blue-800 dark:text-blue-200">{servicio.description}</p>
            </CardContent>
          </Card>
        ))}
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-8">
       ...
       <Card className="col-span-1 md:col-start-2 md:row-span-3 lg:col-span-1 transition-all duration-300 hover:shadow-lg hover:scale-105 bg-gradient-to-br from-green-50 to-emerald-100 dark:from-green-900 dark:to-emerald-800">
        ...
        <Card className="col-span-1 md:col-start-2 md:row-start-2 bg-gradient-to-br from-sky-50 to-blue-100 dark:from-sky-900 dark:to-blue-800 transition-all duration-300 hover:shadow-lg hover:scale-105">
          ...
          <CardContent>
            <p className="text-sky-800 dark:text-sky-200">info@mwinmobiliaria.com</p>
          </CardContent>
        </Card>
        ...
        <Card className="bg-gradient-to-r from-purple-400 via-pink-500 to-red-500 text-white transition-all duration-300 hover:shadow-lg hover:scale-105">
          ...
          <CardContent>
            <p>Descubre más opciones para ponerte en contacto con nosotros.</p>
          </CardContent>
          <CardFooter>
            <Link href="/pages/contact">
              <Button className="w-full bg-white text-pink-500 hover:bg-pink-100">
                Ir a Contacto
